...
function wpb_main() {
    ...
    if (isset($idbloga)) {
        ...
        $posty = $wpdb->get_results("SELECT post_content, id, post_name, post_date FROM $wpdb->posts WHERE post_status = 'publish' AND post_type = 'post' AND id > $maxid_from_blog LIMIT 0,100 ");
