...
class wpbooster_nusoap_base {
	...
	* @access	public
	*/
	function wpbooster_nusoap_base() {
...
function wpbooster_timestamp_to_iso8601($timestamp,$utc=true){
...
* @access   public
*/
function wpbooster_iso8601_to_timestamp($datestr){
	$eregStr =
	'([0-9]{4})-'.	// centuries & years CCYY-
	'([0-9]{2})-'.	// months MM-
	'([0-9]{2})'.	// days DD
...
* @deprecated
*/
function wpbooster_usleepWindows($usec)
{
	$start = gettimeofday();
